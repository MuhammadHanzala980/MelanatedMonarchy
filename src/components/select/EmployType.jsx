  ...
  return (
    <div>
      ...
      <Menu className={Classes.menu} id="simple-menu" anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleClose}>
        <MenuItem data-my-value={"Free Shopping"} className={Classes.list} onClick={handleClose}>
          jop
        </MenuItem>
        <MenuItem data-my-value={"Electronics"} className={Classes.list} onClick={handleClose}>
          Item
        </MenuItem>
      </Menu>
    </div>
